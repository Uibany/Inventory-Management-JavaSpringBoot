...
public class DbSeederService implements CommandLineRunner {
	...
	private void loadInvUsage() {
		...
		Inventory inv1 = new Inventory("200 screws", "100 pieces of screws", 10.00, 11.00, 12.00, 13.00, 1000, 500, 200,
		...
		Inventory inv3 = new Inventory("Tires", "rubber parts of wheel", 5.00, 5.50, 6.00, 6.50, 100, 20, 4, "Black",
				"26rad", subcat2, brand2);
		Inventory inv4 = new Inventory("Rims", "outer edge of wheel", 20.00, 22.00, 24.00, 26.00, 100, 20, 4, "Silver",
